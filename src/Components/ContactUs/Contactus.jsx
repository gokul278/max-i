    ...
    return (
        <div className="bg-[#F5F7F8]">
            ...
            <div className="h-[60vh] flex flex-col justify-center items-center" style={{ backgroundImage: `url(${poster})`, width: "100%", backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <h6 className="text-[18px] text-[#fff] mt-3 uppercase font-semibold flex justify-center items-center cursor-pointer"><div onClick={() => { navigate("/") }}>Home</div>&nbsp;&nbsp;-&nbsp;&nbsp;<div className="text-[#ffaa14]" onClick={() => { navigate("/contact") }}>Conatct Us</div></h6>
            </div>

            <div className="w-[100%]" align="center">
                <h1 className=' w-[90%] lg:-[100%] text-[35px] font-bold capitalize text-[#000] py-10' data-aos="fade-up" align="center">Get In Touch
                </h1>
                ...
                <div className="w-[90%] lg:w-[75%] pb-10 flex flex-col lg:flex-row">
                    <div className="w-[100%] lg:w-[40%] py-10 bg-[#fff] rounded-l-md" style={{ boxShadow: "rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;" }}>
                        <a target="_blank"
                            ...
                            <div className="mt-3 text-[20px] text-[#000] font-bold">0427-3562462</div>
                        </a>
                        <br />
                        <br />
                        ...
                        <a
                            ...
                            <div className="mt-3 text-[20px] text-[#000] font-bold">contact-us@max-idigital.com</div>
                        </a>
                        <br />
                        <br />
                    ...
                    <div className="w-[100%] bg-[#fff] rounded-r-md lg:w-[60%]">
                        <div className="w-[90%]">
                            ...
                            <div class="relative my-6">
                                ...
                                <label for="id-l01" class="cursor-text peer-focus:cursor-default peer-autofill:-top-2 absolute left-2 -top-2 z-[1] px-2 text-xs text-slate-400 transition-all before:absolute before:top-0 before:left-0 before:z-[-1] before:block before:h-full before:w-full before:bg-[#fff] before:transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-required:after:text-pink-500 peer-required:after:content-['\00a0*'] peer-invalid:text-pink-500 peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#ffaa14] peer-invalid:peer-focus:text-pink-500 peer-disabled:cursor-not-allowed peer-disabled:text-slate-400 peer-disabled:before:bg-transparent">
                                    Enter Your Name
                                </label>
                            </div>

                            <div class="relative my-6">
                                <input id="id-l02" type="text" name="id-l01" placeholder="your name" class="relative w-full h-12 px-4 placeholder-transparent transition-all border rounded outline-none focus-visible:outline-none peer bg-[#fff] border-slate-200 text-slate-500 autofill:bg-[#fff] invalid:border-pink-500 invalid:text-pink-500 focus:border-[#ffaa14] focus:outline-none invalid:focus:border-pink-500 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400" />
                                <label for="id-l02" class="cursor-text peer-focus:cursor-default peer-autofill:-top-2 absolute left-2 -top-2 z-[1] px-2 text-xs text-slate-400 transition-all before:absolute before:top-0 before:left-0 before:z-[-1] before:block before:h-full before:w-full before:bg-[#fff] before:transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-required:after:text-pink-500 peer-required:after:content-['\00a0*'] peer-invalid:text-pink-500 peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#ffaa14] peer-invalid:peer-focus:text-pink-500 peer-disabled:cursor-not-allowed peer-disabled:text-slate-400 peer-disabled:before:bg-transparent">
                                    Enter E-Mail
                                </label>
                            </div>

                            <div class="relative  pb-5">
                                <textarea id="id-l03" type="text" name="id-l01" rows="3" placeholder="Write your message" class="relative w-full p-4 placeholder-transparent transition-all border rounded outline-none focus-visible:outline-none peer bg-[#fff] border-slate-200 text-slate-500 autofill:bg-[#ffaa14] invalid:border-pink-500 invalid:text-pink-500 focus:border-[#ffaa14] focus:outline-none invalid:focus:border-pink-500 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400"></textarea>
                                <label for="id-l03" class="cursor-text peer-focus:cursor-default absolute left-2 -top-2 z-[1] px-2 text-xs text-slate-400 transition-all before:absolute before:top-0 before:left-0 before:z-[-1] before:block before:h-full before:w-full before:bg-[#fff] before:transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-required:after:text-pink-500 peer-required:after:content-['\00a0*'] peer-invalid:text-pink-500 peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#ffaa14] peer-invalid:peer-focus:text-pink-500 peer-disabled:cursor-not-allowed peer-disabled:text-slate-400 peer-disabled:before:bg-transparent">
                                    Write your message
                                </label>
                            </div>

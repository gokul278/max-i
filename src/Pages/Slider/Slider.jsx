                                    ...
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            ...
                                            <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-[#ffaa14]">
                                                <div className="flex items-center gap-4 pt-4 text-sm text-left text-[#ffaa14]">
                                                    <img
                                                        src={zadroit}
                                                        alt="ZAdroit"
                                                        title="ZAdroit"
                                                        width="80"
                                                        height="80"
                                                        className="max-w-full border-[3px] border-black rounded-full shrink-0"
                                                    />
                                ...
                                <div className="overflow-hidden ">
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            ...
                                            <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-[#ffaa14]">
                                                <div className="flex items-center gap-4 pt-4 h-[100px] text-sm text-left text-[#ffaa14]">
                                                    <img
                                                        src={big}
                                                        alt="ZAdroit"
                                                        title="ZAdroit"
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        <span className="font-bold text-[20px] uppercase">
                                                            Big Brains,<br /> The Brain Gym coding <br /> classes for kids
                                                        </span>
                                                    </div>
                                                </div>
                                            </figcaption>
